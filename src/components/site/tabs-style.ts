...
export const editorialTabsList =
    "inline-flex items-center gap-[2px] h-auto rounded-[var(--radius-md)] bg-[color:var(--bg-inset)] border border-[color:var(--rule-subtle)] p-[2px] text-[color:var(--fg-subtle)]";
...
export const terminalTabsList =
    "flex flex-wrap gap-1 mb-[14px] bg-transparent border-0 p-0 h-auto rounded-none text-[color:var(--fg-subtle)]";
