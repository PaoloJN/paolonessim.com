...
export default function Location({ index, className }: LocationProps) {
    ...
    return (
        <Section index={index} className={className}>
            <div className="relative w-full h-[200px] rounded-lg overflow-hidden border-[1px] border-border/40">
                <Map
